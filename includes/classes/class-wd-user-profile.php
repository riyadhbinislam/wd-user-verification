...
class WD_User_Profile{
    ...
    public function init() {
        ...
        add_shortcode('user_verification_clean_user_meta', array($this, 'user_verification_clean_user_meta'));

        add_action('user_verification_clean_user_meta', array($this, 'user_verification_clean_user_meta'));

        add_action('user_verification_delete_unverified_user', array($this, 'user_verification_delete_unverified_user'));

        add_action('user_verification_existing_user_verified', array($this, 'user_verification_existing_user_verified'));
        add_action('user_verification_activation', array($this, 'user_verification_upgrade_settings'));
    }
    ...
    public function user_verification_clean_user_meta(){
    ...
    public function user_verification_delete_unverified_user(){
    ...
    public function user_verification_existing_user_verified(){
    ...
    public function user_verification_upgrade_settings(){
...
$wd_user_profile = new WD_User_Profile();