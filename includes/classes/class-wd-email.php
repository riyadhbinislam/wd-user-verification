...
class WD_Email{
    ...
    public function email_templates_data()
    {
        ...
        include WD_USER_VERIFICATION_PATH . 'templates/emails/user_registered.php';
        include WD_USER_VERIFICATION_PATH . 'templates/emails/email_confirmed.php';
        include WD_USER_VERIFICATION_PATH . 'templates/emails/email_resend_key.php';
        include WD_USER_VERIFICATION_PATH . 'templates/emails/send_mail_otp.php';
        include WD_USER_VERIFICATION_PATH . 'templates/emails/email_reminder.php';
