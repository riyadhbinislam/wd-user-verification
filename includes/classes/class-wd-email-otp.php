...
class WD_Email_OTP{
    ...
    public function init() {
        ...
        add_filter('check_password', array($this, 'user_verification_check_password_otp_default_login'), 90, 4);
        add_action('wp_logout', array($this, 'user_verification_clear_otp_on_logout'));

        add_filter('authenticate', array($this, 'user_verification_auth_otp_default_login'), 99, 2);
        add_filter('authenticate', array($this, 'user_verification_auth_otp_woocommerce_login'), 99, 2);
    }
...
*/
    ...
    ?>
        ...
        // wp_localize_script('user_verification_scripts_login', 'user_verification_ajax', array('user_verification_ajaxurl' => admin_url('admin-ajax.php')));
